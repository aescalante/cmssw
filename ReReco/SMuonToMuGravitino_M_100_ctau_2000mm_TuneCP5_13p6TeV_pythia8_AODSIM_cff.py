...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov///store/user/rlopezru/SMuonToMuGravitino_M_100_2000mm_13p6TeV_GENSIM_2022MC_v01/PREMIXRAW_v02/250206_105457/0000/output_PREMIXRAW_100.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--python_filename nevts:8'),

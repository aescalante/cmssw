...
# gen level
h_genlxy_all= create_histogram("h_genlxy_all", "Generated Lxy", 250, 0, 500, "Gen. L_{xy} [cm]", "Entries")
h_genpt_all= create_histogram("h_genpt_all", "Generated muon pT ", 40, 0, 200, "DSA p_{T} [GeV]", "Entries")
h_geneta_all= create_histogram("h_geneta_all", "Generated muon #eta ", 15, -2.5, 2.5, "Gen. #eta", "Entries")
h_genlxy = create_histogram("h_genlxy", "Generated Lxy", 100, 0, 100, "L_{xy} [cm]", "Entries")
h_genpt = create_histogram("h_genpt", "Generated muon pT ", 40, 0, 200, "Gen. p_{T} [GeV]", "Entries")
h_geneta = create_histogram("h_geneta", "Generated muon #eta", 15, -2.5, 2.5, "Gen. #eta", "Entries")
h_genpt_dsa = create_histogram("h_genpt_dsa", "Generated muon pT (matched to dsa)", 40, 0, 200, "Gen. p_{T} [GeV]", "Entries")
...
h_dr_dtk = create_histogram("h_dr_dtk", "dR(dgb, dTk)", 40, 0, 0.5, "#Delta R(dgb, dTk)", "Entries")
h_pt_dsa = create_histogram("h_pt_dsa", "Displaced StandAlone ", 40, 0, 200, "DSA p_{T} [GeV]", "Entries")
h_dr_dsa = create_histogram("h_dr_dsa", "dR(dgb, dsa)", 40, 0, 0.5, "#Delta R(dgb, dsa)", "Entries")
h_pt_earlyOuter = create_histogram("h_pt_earlyOuter", "Early Outer ", 40, 0, 200, "Early Outer p_{T} [GeV]", "Entries")
h_dr_earlyOuter = create_histogram("h_dr_earlyOuter", "dR(dgb, earlyOuter)", 40, 0, 0.5, "#Delta R(dgb, earlyOuter)", "Entries")
